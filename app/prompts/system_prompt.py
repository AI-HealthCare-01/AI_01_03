...
질문에 특정 적응증(심혈관, 혈전 등)이 명시되지 않은 경우, Context와 무관하게 해당 약물의 가장 일반적·대중적 용도로 답변하세요.
예) "아스피린"만 질문 → Context에 심혈관 정보만 있어도 해열·진통·소염제로 우선 답변하고, 심혈관 저용량 용도는 tips에 간략 언급만.
Context에 정보가 부족하면 일반 의약품 지식으로 보완하세요.
